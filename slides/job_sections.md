...
![sections_of_a_free_style_project](/slides/images/sections_of_a_free_style_project.png)<!-- .element: class="plain" -->
...
![freestyle_general_section](/slides/images/freestyle_general_section.png)<!-- .element: class="plain" -->
...
![free_style_general_section_advanced](/slides/images/free_style_general_section_advanced.png)<!-- .element: class="plain" -->
...
![freestyle_source_code_section](/slides/images/freestyle_source_code_section.png)<!-- .element: class="plain" -->
...
![freestyle_build_triggers_section](/slides/images/freestyle_build_triggers_section.png)<!-- .element: class="plain" -->
...
![freestyle_build_environment_section](/slides/images/freestyle_build_environment_section.png)<!-- .element: class="plain" -->
...
![freestyle_build_section](/slides/images/freestyle_build_section.png)<!-- .element: class="plain" -->
...
![freestyle_post_build_actions_section](/slides/images/freestyle_post_build_actions_section.png)<!-- .element: class="plain" -->
